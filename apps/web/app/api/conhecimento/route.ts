...
// Proxy da tela de Conhecimento: as dimensões e opções com que o salão
// classifica um cabelo.
//
// Rota própria, como /api/clientes e /api/agente. Salvar aqui exige papel
// OWNER na própria RPC — quem opera o dia a dia não redefine o vocabulário do
// salão.
const ACTIONS = new Set(['loadKnowledge', 'saveKnowledge']);
