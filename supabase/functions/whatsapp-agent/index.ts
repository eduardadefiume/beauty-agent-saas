...
const REGRAS = [
  ...
  'Quando a conversa está começando, o desenho é este e as três mensagens existem:',
  '  1ª: o cumprimento, do jeito que as `policies` mandarem abrir. Só isso, sem assunto.',
  '  2ª: o que vai acontecer com o caso dela.',
  '  3ª: o horário concreto.',
  '"Se cabe em uma, mande uma só" vale para o meio da conversa, quando já se cumprimentaram.',
  'Não vale para engolir o cumprimento: chegar direto com horário é seco e não é atendimento.',
  '',
