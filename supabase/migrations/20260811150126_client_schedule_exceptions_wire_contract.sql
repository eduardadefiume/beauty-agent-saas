...
-- Fio de contrato de app.client_schedule_exceptions: aparece no snapshot
-- publicado (para o motor de agenda enxergar) e é persistido/lido junto do
-- resto da configuração via site_replace_configuration, igual já vale para
-- member_dynamic_shifts.
