-- Cliente nova nao tem ficha, e sem ficha a lista de pendencias vinha vazia.
-- Resultado: a trava da investigacao ficava desligada justamente para quem mais
-- precisa dela. Sem ficha, TUDO falta.
...
-- Escrever na ficha de quem ainda nao tem ficha cria a ficha. Antes disto, a
-- primeira coisa que o agente descobrisse de uma cliente nova era jogada fora.
...
-- E o contexto passa a mandar a lista tambem quando nao ha ficha nenhuma.
do $do$
declare
  v_def text;
begin
